...
const WEATHER_CODES = {
    0: { label: 'Ciel dégagé', icon: 'sun', bg: 'linear-gradient(135deg, var(--bg-peach) 0%, var(--bg-rose) 100%)' },
    1: { label: 'Principalement dégagé', icon: 'cloud-sun', bg: 'linear-gradient(135deg, var(--bg-peach) 0%, var(--bg-rose) 100%)' },
    2: { label: 'Partiellement nuageux', icon: 'cloud-sun', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, var(--bg-sky) 100%)' },
    3: { label: 'Couvert', icon: 'cloud', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, var(--border-light) 100%)' },
    45: { label: 'Brouillard', icon: 'mist', bg: 'linear-gradient(135deg, var(--bg-white) 0%, var(--border-light) 100%)' },
    48: { label: 'Brouillard givrant', icon: 'mist', bg: 'linear-gradient(135deg, var(--bg-white) 0%, var(--border-light) 100%)' },
    51: { label: 'Bruine légère', icon: 'rain-light', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    53: { label: 'Bruine modérée', icon: 'rain', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    55: { label: 'Bruine dense', icon: 'rain', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    56: { label: 'Bruine verglaçante légère', icon: 'rain-snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    57: { label: 'Bruine verglaçante dense', icon: 'rain-snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    61: { label: 'Pluie faible', icon: 'rain-light', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    63: { label: 'Pluie modérée', icon: 'rain', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    65: { label: 'Pluie forte', icon: 'rain-heavy', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #A5DBFF 100%)' },
    66: { label: 'Pluie verglaçante légère', icon: 'rain-snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    67: { label: 'Pluie verglaçante forte', icon: 'rain-snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    71: { label: 'Chute de neige légère', icon: 'snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    73: { label: 'Chute de neige modérée', icon: 'snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    75: { label: 'Chute de neige forte', icon: 'snow-heavy', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #E0F2FE 100%)' },
    77: { label: 'Grains de neige', icon: 'snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    80: { label: 'Averses de pluie faibles', icon: 'rain-light', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    81: { label: 'Averses de pluie modérées', icon: 'rain', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #C0E8FF 100%)' },
    82: { label: 'Averses de pluie violentes', icon: 'rain-heavy', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #A5DBFF 100%)' },
    85: { label: 'Averses de neige faibles', icon: 'snow', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, var(--bg-lavender) 100%)' },
    86: { label: 'Averses de neige fortes', icon: 'snow-heavy', bg: 'linear-gradient(135deg, var(--bg-sky) 0%, #E0F2FE 100%)' },
    95: { label: 'Orage faible ou modéré', icon: 'thunderstorm', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, #E9D5FF 100%)' },
    96: { label: 'Orage avec grêle faible', icon: 'thunderstorm', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, #E9D5FF 100%)' },
    99: { label: 'Orage avec grêle forte', icon: 'thunderstorm', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, #E9D5FF 100%)' },
};

const DEFAULT_WEATHER = { label: 'Temps variable', icon: 'cloud', bg: 'linear-gradient(135deg, var(--bg-lavender) 0%, var(--border-light) 100%)' };
